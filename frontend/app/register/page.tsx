    ...
    <div className="auth-page">
      <div className="auth-card">
        <div className="auth-brand">
          ...
          <p className="auth-subtitle">Join NeuronAgent for free</p>
        </div>
            ...
            <div className="form-group" key={field}>
              ...
              <input
                ...
                placeholder={
                  ...
                  field === "username" ? "neuron_user" : "Min 8 characters"
                }
      ...
      <style jsx>{`
        .auth-page {
          ...
          background-image: radial-gradient(ellipse at 80% 50%, rgba(139, 92, 246, 0.08) 0%, transparent 60%),
        ...
        .auth-error {
          ...
          color: #fca5a5; border-radius: var(--radius-md); padding: 0.75rem 1rem; font-size: 14px;
        }
        ...
        .auth-footer { margin-top: 1.5rem; text-align: center; font-size: 14px; color: var(--text-secondary); }
